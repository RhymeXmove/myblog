...
#nexmoe-header {
    ...
    .nexmoe-list {
        ...
        .nexmoe-list-item.active,
        .nexmoe-list-item.active i {
            color: #fff;
        }
...
.nexmoe-rainbow-fill {
    ...
    a:nth-child(7n+2) {
        color: #fff;
        background-color: rgb(255, 118, 30, 0.8);
    }
    a:nth-child(7n+3) {
        color: #fff;
        background-color: rgb(255, 185, 0, 0.8);
    }
    a:nth-child(7n+4) {
        color: #fff;
        background-color: rgb(51, 213, 122, 0.8);
    }
    a:nth-child(7n+5) {
        color: #fff;
        background-color: rgb(0, 219, 255, 0.8);
    }
    a:nth-child(7n+6) {
        color: #fff;
        background-color: rgb(26, 152, 255, 0.8);
    }
    a:nth-child(7n+7) {
        color: #fff;
        background-color: rgb(144, 144, 255, 0.8);
    }
}